...
#define SLOT1_CARD_DETECT_GPIO 160
#define SLOT3_CARD_DETECT_GPIO 97
#define SLOT2_WIFI_WAKEUP_GPIO 94
...
// Jagan+
    ...
    #define ADDR_4325_DHD_PORT_LEN              SZ_16K
    #define ADDR_4325_BUS_RXBUF_LEN             SZ_16K
    #define ADDR_4325_BUS_DATABUF_LEN   SZ_32K
    void *addr_4325_dhd_prot,*addr_4325_bus_rxbuf,*addr_4325_bus_databuf;
    EXPORT_SYMBOL(addr_4325_dhd_prot);
    EXPORT_SYMBOL(addr_4325_bus_rxbuf);
    EXPORT_SYMBOL(addr_4325_bus_databuf);
#endif
// Jagan-
...
//	if (length > WLAN_MAC_ADDR_SIZE) return;
...
// static int mddi_power_save_on; /* Jagan+ ... Jagan- */
...
// Jagan+
#ifdef CONFIG_TOUCHSCREEN_AUO
static struct auo_touchscreen_platform_data auo_touchscreen_data = {
        .gpioirq = 43,
        .gpiorst = 18,
};
#endif
...
#ifdef CONFIG_TOUCHSCREEN_AUO
    	{
        I2C_BOARD_INFO("auo_touchscreen", 0x5C),
        .type          = "auo_touchscreen",
        .irq           = MSM_GPIO_TO_INT(43),
        .platform_data = &auo_touchscreen_data
	},
#endif
// Jagan-
...
static uint32_t camera_on_gpio_surf_table[] = {
    GPIO_CFG(2,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA), /* CAM_PWDN */
    GPIO_CFG(3,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* CAM_RESET */
    GPIO_CFG(104, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA), /* CAM_SUB_PWDN */
};

static uint32_t camera_off_gpio_surf_table[] = {
	GPIO_CFG(2,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* CAM_PWDN */
	GPIO_CFG(3,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* CAM_RESET */
    GPIO_CFG(104, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* CAM_SUB_PWDN */
};
// Jagan-
...
static struct platform_device *devices[] __initdata = {
	&msm_fb_device,
#if 0
#ifdef CONFIG_SMC91X 		/* Jagan+ .... Jagan- */
	&smc91x_device,
#endif
#endif
	&msm_device_smd,
	...
	&msm_device_tssc,
	&msm_audio_device,
	&msm_device_uart_dm2,					/* Jagan+ ... Jagan- */
...
#endif
// Jagan-
	&qsd_headset_device,						/* Jagan+ ... Jagan- */
};
...
//	.translate_vdd	= msm_sdcc_setup_power,
	...
	.dummy52_required = 1,
#endif
	.status_irq	= MSM_GPIO_TO_INT(SLOT1_CARD_DETECT_GPIO),
	.msmsdcc_fmin	= 144000,
...
// Jagan+
        {
                unsigned int ProcArg1=0, ProcArg2Uart1=0;
                int retTempValue=0;
                platform_device_register(&msm_device_uart1);
                ProcArg1 = SMEM_PC_OEM_UART_LOG_STATUS;
                retTempValue=cust_mproc_comm1(&ProcArg1,&ProcArg2Uart1);
		if (1)
                {
...
// Jagan+
#ifdef CONFIG_WLAN_ALLOC_STATIC_MEM
        addr_4325_dhd_prot      = alloc_bootmem(ADDR_4325_DHD_PORT_LEN);
        addr_4325_bus_rxbuf     = alloc_bootmem(ADDR_4325_BUS_RXBUF_LEN);
        addr_4325_bus_databuf   = alloc_bootmem(ADDR_4325_BUS_DATABUF_LEN);
        printk(KERN_CRIT "dhd_port=0x%p,bus_rxbuf=0x%p,bus_databuf=0x%p\n",
                        addr_4325_dhd_prot,addr_4325_bus_rxbuf,addr_4325_bus_databuf);
#endif
// Jagan-
}
